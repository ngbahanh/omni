...
// Tool-specific defaults (shared settings live in omni-global config)
...
export const YT_DLP_FLAGS = {
  ...
  thumbnail: ["--write-thumbnail", "--convert-thumbnails", "jpg"],
  metadata: ["--write-info-json", "--add-metadata"],
  antiBlock: [
    "--sleep-interval",
    "1",
    "--max-sleep-interval",
